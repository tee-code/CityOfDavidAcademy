...
<div class="container">
    ...
    <div class="card container mt-3">
        <div class="card-header fancy-header">
                <p class="card-title">{{ __('Users') }}</p>
                <p class="card-category">{{ __('Here you can manage users') }}</p>
        </div>
        <div class="card-body">
            <button class="btn btn-primary float-right mb-2" data-toggle="modal" data-target="#exampleModalCenter">Add User</button>
            <!-- Modal -->
            ...
            <table class="table">
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <span data-toggle="modal" data-target="#edit-{{ $user->id }}" class="fas fa-pen-alt mx-1"></span>
                                    ...
                                    <div class="modal fade bd-example-modal-lg" id="edit-{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-theme-color">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Edit {{ $user->name }} Record</h5>
                                                        <button type="button text-white" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span class = "text-white" aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                    ...
                                    @if(auth()->user()->role === "Super Admin" && $user->id !== auth()->user()->id)
                                        <span class="fas fa-trash-alt mx-1" data-toggle="modal" data-target="#delete-{{ $user->id }}"></span>
                                        <!-- Modal -->
